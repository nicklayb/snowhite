defmodule Snowhite.Modules.Suntime do
  ...
  # Icons by Yelena Polyakov https://thenounproject.com/Yelena
      ...
      <div>
        <ul>
          ...
          <li>
            ...
            <div class="times">
              <div class="sunrise">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 102.5" enable-background="new 0 0 100 82" xml:space="preserve">
                  <g>
